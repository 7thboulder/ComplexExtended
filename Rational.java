...
public class Rational
{
    ...
    private void reduce() //why no parameters?
    {
        ...
        {
            int gcdStore = gcd(numerator, denominator);
            numerator /= gcdStore;
            denominator /= gcdStore;
        }
    ...
    public String toString()
    {
        ...
        {
            return (numerator - (numerator % denominator)) / denominator + " " + numerator % denominator + "/" + denominator;
        }
        else
        {
    ...
    */ 
    ...
    {
        return new Rational(this.numerator * rhs.getNumerator() , this.denominator * rhs.getDenominator());
    ...
    public boolean lessThan(Rational rhs)
    {
        int gcd1 = gcd(this.denominator, rhs.denominator);
        return this.numerator * gcd1 < rhs.numerator * gcd1;
    ...
    public static void main(String[] args)
    {
        ...
        Rational r5 = new Rational(3,9, 4);
        System.out.println(r5);
        Rational r6 = new Rational(0,1, 4);
        System.out.println(r6);
        Rational r7 = new Rational(0,5, 4);
        System.out.println(r7);
        Rational r8 = new Rational(1,0, 4);
        System.out.println(r8);
        Rational r9 = new Rational(4, 4);
        ...
        System.out.println(product3);
         ...
         Rational product5 = r2.divide(r4);
